...
ssize_t block_driver_read_blocks(struct block_buffer_desc_t* start, size_t count, int timeout);
ssize_t block_driver_write_blocks(const struct block_buffer_desc_t* start, size_t count, int timeout);
